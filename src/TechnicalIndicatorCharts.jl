...
function visualize(chart::Chart;
    ...
    return lwc_layout(
        ...
        make_panel.(plots_other; h=other_h)...;
        min_height
    )
end
...
include("BOP.jl")
include("CCI.jl")
include("ChandeKrollStop.jl")
include("ChaikinOsc.jl")
include("CHOP.jl")
include("CoppockCurve.jl")
include("DEMA.jl")
include("DonchianChannels.jl")
include("DPO.jl")
include("EMA.jl")
include("EMV.jl")
include("ForceIndex.jl")
include("HMA.jl")
include("KAMA.jl")
include("KeltnerChannels.jl")
include("KST.jl")
include("KVO.jl")
include("MACD.jl")
include("MassIndex.jl")
include("McGinleyDynamic.jl")
include("MeanDev.jl")
include("OBV.jl")
include("ParabolicSAR.jl")
include("PivotsHL.jl")
include("ROC.jl")
include("RSI.jl")
include("SMA.jl")
